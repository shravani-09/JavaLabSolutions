...
public class EISTester {
	...
	private static Integer addEmployee(Employee employee) throws EmployeeException 
	{
		...
		Integer empid=service.addEmployee(employee); //calling add method of employeeserviceimpl class
		return empid;
	}
		...
		while(true) 
		{
			...
			try {
				...
				case 1: Employee employee=new Employee();
						...
						//local method addEmployee returns id which is saved in empid
						Integer empid=addEmployee(employee);
						//printing successful message after adding employee
